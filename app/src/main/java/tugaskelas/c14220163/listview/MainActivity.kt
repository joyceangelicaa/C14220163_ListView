package tugaskelas.c14220163.listview
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //button buat nambah data
        val _btnTambah = findViewById<Button>(R.id.btnTambah)
        _btnTambah.setOnClickListener {
            var dtAkhir = Integer.parseInt(data[data.size - 1]) + 1
        ...
        //button buat hapus data
        val _btHapus = findViewById<Button>(R.id.btHapus)
        _btHapus.setOnClickListener {
            data.removeFirst()
            lvAdapter.notifyDataSetChanged()
        }
